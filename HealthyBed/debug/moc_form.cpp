...
QT_MOC_LITERAL(1, 5, 34), // "signal_edit_set_speed_to_Dial..."
QT_MOC_LITERAL(2, 40, 0), // ""
QT_MOC_LITERAL(3, 41, 3), // "str"
QT_MOC_LITERAL(4, 45, 20) // "get_textEdit_content"

    },
    "Form\0signal_edit_set_speed_to_Dialogwin\0"
    "\0str\0get_textEdit_content"
};
...
void Form::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_edit_set_speed_to_Dialogwin((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->get_textEdit_content(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Form::signal_edit_set_speed_to_Dialogwin)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Form::signal_edit_set_speed_to_Dialogwin(QString _t1)
{
